...
instance Print Expr where
  prt i e = case e of
    ...
    E_Lambda pdecls type_ block -> prPrec i 8 (concatD [doc (showString "("), prt 0 pdecls, doc (showString ")"), doc (showString "->"), prt 0 type_, doc (showString "in"), prt 0 block])
...
instance Print Type where
  prt i e = case e of
    ...
    T_Tup type_ types -> prPrec i 0 (concatD [doc (showString "("), prt 0 type_, doc (showString ","), prt 0 types, doc (showString ")")])
    T_Ref type_ -> prPrec i 0 (concatD [doc (showString "&"), prt 0 type_])
    T_Foo type_ -> prPrec i 0 (concatD [doc (showString "func"), doc (showString "("), doc (showString ")"), doc (showString "->"), prt 0 type_])
    T_FooA types type_ -> prPrec i 0 (concatD [doc (showString "func"), doc (showString "("), prt 0 types, doc (showString ")"), doc (showString "->"), prt 0 type_])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
